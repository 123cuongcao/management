...
import {
    addCourse,
} from "/src/features/courses/CourseSlice.js";
  ...
  useEffect(() => {
    if (error && formikRef.current) {
      formikRef.current.setErrors({
        title: error?.errorsDetails.name,
        description: error?.errorsDetails.address,
        courseTime: error?.errorsDetails.phoneNumber,
