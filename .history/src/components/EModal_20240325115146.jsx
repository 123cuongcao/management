  ...
  useEffect(() => {
    if (error && formikRef.current) {
      formikRef.current.setErrors({
        ...
        coursesId: updateError?.errorsDetails.address,
        : updateError?.errorsDetails.phoneNumber,
        maxStudent: updateError?.errorsDetails.email,
        startTime: updateError?.errorsDetails.dob,
      });
    }
  }, [updateError]);
