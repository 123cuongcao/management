        ...
        <div className="p-4 rounded-lg mt-14">
          <div className="flex justify-between items-center mb-4">
            ...
            <form className="flex items-center max-w-sm mx-auto ">
              ...
              <button
                type="submit"
                className="p-2.5 ms-2 text-sm font-medium text-white bg-red-750 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
               Search
