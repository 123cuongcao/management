  ...
  useEffect(() => {
    if (error && formikRef.current) {
      formikRef.current.setErrors({
        teacherID: error?.errorsDetails.teacherID,
        name: error?.errorsDetails.description,
        email: error?.errorsDetails.courseTime,
        phoneNumber: error?.errorsDetails.courseTime,
        address: error?.errorsDetails.courseTime,
        dob: error?.errorsDetails.courseTime,
      });
    }
  }, [error]);
