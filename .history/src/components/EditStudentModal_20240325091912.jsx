...
function EditStudentNumber({ data }) {
  ...
  useEffect(() => {
    if (!isModalOpen) {
      const modalId = "editBcrud-modal-edit2tton2";
      const modal = document.querySelector(`[data-modal-toggle="${modalId}"]`);
      if (modal) {
        modal.dataset.modalHide = modalId;
      }
    }
  }, [isModalOpen])
  ...
  //     // Hàm xử lý submit như bạn đã viết, nhưng thêm việc hiển thị modal xác nhận
