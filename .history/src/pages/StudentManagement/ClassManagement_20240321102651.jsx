    ...
    <>
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 rounded-lg mt-14">
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg" style={{zIndex:"-1!important"}}>
            <table style={{zIndex:"-1!important"}} className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody style={{zIndex:"-1!important"}}>
                {classes?.map((cls) => {
                  return (
                    <tr
                      key={cls.id}
                    ...
                    >
                      ...
                      <td style={{zIndex:"0!important"}}  className="px-6 py-4 text-right">
                        {/* <Link
                          to="/editmodal"
                          className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        >
