...
function LoginPage() {
  ...
  const socialMediaIcons = [
    { src: "https://cdn.builder.io/api/v1/image/assets/TEMP/b0855679b3d6ac009e1be3ce5645df8568f7ddea1f5354caf64c14d2bd0383ad?apiKey=a365ccf4d9914ba4a3de4c73152edf03&", alt: "Social media icon 1" },
    { src: "https://cdn.builder.io/api/v1/image/assets/TEMP/8b44504f6bafce94215c89c237baedc99e9c2fc8c976ccfa45e6bd2fca411659?apiKey=a365ccf4d9914ba4a3de4c73152edf03&", alt: "Social media icon 2" },
  ];
  ...
  return (
    ...
    // </div>
    <main className="px-16 pt-9 pb-20 bg-white rounded-2xl border border-black border-solid max-w-[864px] max-md:px-5">
    <div className="flex gap-5 max-md:flex-col max-md:gap-0" style={{display:"flex"}}>
      <section className="flex flex-col w-[54%] max-md:ml-0 max-md:w-full">
        <div className="flex grow gap-5 items-start text-3xl font-bold leading-9 text-slate-900 max-md:mt-10">
          <div className="flex flex-col grow shrink-0 self-start shadow-sm basis-0 w-fit">
            ...
            />
            <h1 className="mt-14 max-md:mt-10">
      ...
      <section className="flex flex-col ml-5 w-[46%] max-md:ml-0 max-md:w-full">
        <form className="flex flex-col self-stretch my-auto text-sm font-medium text-gray-600 max-md:mt-10">
          ...
          <button
            type="submit"
            style={{background:"#BC2228"}}
            className=" px-16 py-5 mt-4 text-base leading-8 text-center text-white bg-red-700 rounded-md max-md:px-5"
          >
            Sign In
          </button>
        </form>
        <a href="#" className="self-center mt-7 text-center leading-[214%]">
          Forgot password?
        </a>
        <p className="self-center mt-4 leading-8 text-center">
...
//             <button
//               type="submit"
//               className="justify-center items-center px-16 py-5 mt-4 text-base leading-8 text-center text-white bg-red-700 rounded-md max-md:px-5"
//             >
//               Sign In
//             </button>
//           </form>
