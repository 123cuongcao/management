...
function LoginPage() {
  ...
  return (
    ...
    // </div>
    <main className="  rounded-2xl  max-w-[864px] max-md:px-5">
    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
      ...
      <section className="flex flex-col ml-5 w-[46%] max-md:ml-0 max-md:w-full">
        <form className="flex flex-col self-stretch my-auto text-sm font-medium text-gray-600 max-md:mt-10">
          ...
          <button
            type="submit"
            className="justify-center  items-center px-20 py-2 mt-6 text-base leading-8 text-center text-white bg-red-700 rounded-md max-md:px-5"
          >
            Sign In
          </button>
        </form>
