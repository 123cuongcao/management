...
function LoginPage() {
  ...
  return (
    ...
    // </div>
    <main className="px-5 pt-9 pb-20 bg-white rounded-2xl border border-black border-solid max-w-[864px] mx-auto">
    <div className="flex gap-5 flex-col-reverse max-md:flex-col max-md:gap-0">
      <section className="flex flex-col w-[54%] max-md:w-full">
        <div className="flex grow gap-5 items-start text-3xl font-bold leading-9 text-slate-900">
          <div className="flex flex-col grow shrink-0 self-start shadow-sm w-fit">
            <img
              loading="lazy"
            ...
            <img
              ...
              className="mt-14 w-full aspect-[0.99]"
            />
          </div>
          <div className="self-end mt-11 w-px border border-black border-solid shadow-sm h-[641px]" />
        </div>
      </section>
      <section className="flex flex-col ml-5 w-[46%] max-md:ml-0 max-md:w-full">
        <form className="flex flex-col self-stretch my-auto text-sm font-medium text-gray-600">
          ...
          <button
            type="submit"
            className="justify-center items-center px-20 py-5 mt-4 text-base leading-8 text-center text-white bg-red-700 rounded-md max-md:px-5"
          >
            Sign In
          </button>
        </form>
