                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <a
deleteC                          className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        >
                          Delete
                        </a>
                      </td>
                ...
                {/* {
                  <button
                    ...
                    className="blo1ck text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button"
                  >
                    Toggle modal 99999
                  </button>
                } */}
                {
                  <button
                    id="editButton1"
                    style={{ display: "none" }}
                    data-modal-target="crud-modal-edit1"
                    data-modal-toggle="crud-modal-edit1"
                    className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button"
                  ></button>
                }
            ...
            {<EModal data={data} setFlag={setFlag} />}
