...
import Modal from "../../components/AddClassModal.jsx";
...
// import {studentAction} from "../../features/students/StudentSlice.js";
...
function ClassManagement() {
  ...
  useEffect(() => {
    if (fetchStatus === "idle") {
      dispatch(fetchStudents({ page: 0, size: 20, keyword }));
    }
  }, [keyword, fetchStatus,dispatch]);
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <a className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                          Delete
                        </a>
                      </td>
